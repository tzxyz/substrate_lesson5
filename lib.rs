...
mod erc20 {
    ...
    mod tests {
        ...
        #[ink::test]
        fn erc20_contract_should_be_works() {
        ...
        #[ink::test]
        fn total_supply_should_be_works() {
        ...
        #[ink::test]
        fn transfer_should_be_works() {
            let total_supply = 10000;
            let transfer_amount = 100;
            let mut erc20 = Erc20::new(total_supply);
            let accounts = ink::env::test::default_accounts::<ink::env::DefaultEnvironment>();
            assert_eq!(erc20.balance_of(accounts.bob), 0);
            assert_eq!(erc20.transfer(accounts.bob, transfer_amount), Ok(()));
